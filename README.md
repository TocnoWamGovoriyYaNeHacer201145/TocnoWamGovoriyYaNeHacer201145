...
I'm a beginner Python developer, a fan of creating interpreters of programming languages (don't be surprised if you find a lot of them in my profile). On top of that, I'm also trying a little bit of [Kotlin](https://github.com/JetBrains/kotlin) (fun fact: I live in a city on the island after which this language is named) and Forth.
